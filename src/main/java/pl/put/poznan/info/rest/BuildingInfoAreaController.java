...
public class BuildingInfoAreaController {
    ...
    public String buildingArea(@RequestBody String buildingData) {
    ...
    public String levelArea(@RequestBody String buildingData, @PathVariable String id) {
    ...
    public String roomArea(@RequestBody String buildingData, @PathVariable String id) {
